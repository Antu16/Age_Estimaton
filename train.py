...
def get_args():
    ...
    parser.add_argument("--appa_dir", type=str, default ="D:\\Thesis\\Dataset\\appa-real-release" ,
                        help="path to the APPA-REAL dataset")
    parser.add_argument("--utk_dir", type=str, default="D:\\Thesis\\Dataset\\utkface\\croped_faces",
                        help="path to the UTK crop face dataset")
